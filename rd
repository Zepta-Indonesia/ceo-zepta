...
def psb(z):
	...
	for e in z + '\n':
		...
		sys.stdout.write#!/usr/bin/python2
...
\033[1;92m _____   __________  _________

\033[1;92m  /__  /  / ____/ __ \/_  __/   |

\033[1;92m  / /  / __/ / /_/ / / / / /| |

\033[1;92m / /__/ /___/ ____/ / / / ___ |

\033[1;92m /____/_____/_/     /_/ /_/  |_|  
...
\033[1;92m Harap Gunakan Script Ini Dengan Bener  Ya Asw !!!

\033[1;92m Kaga Subrek Channel Gw Auto Burik Loh !

\033[1;92m Intinya all mem zepta :adit-radian-galeh-surya-revi-zulvan-bobbi-diana dll.

\033[1;92m................\033[1;96m✬Recode : Zepta Indonesia✬\033[1;91m..............
...
\033[1;91m☞ Auther     : Radian Pratama✅

\033[1;92m☞ Facebook   : RADIANSYAH

\033[1;95m☞ YouTube    : Radianpratama😕
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Zepta Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' Facebook Ceo ZeptaIndonesia')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone git clone https://github.com/radiangarutxd/zeptaindonesia/')
	    ...
	    psb('Facebook Name RADIANSYAH✓')

	    psb('WellCome To Zepta Script :)')
	    ...
	    psb('Subscrib My Youtube Chanell Radianpratama✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/radiangrt && python2 dkfb')

	elif bm =='3':

	    os.system('xdg-open https://www.facebook.com/CEO ZEPTA INDONESIA')
